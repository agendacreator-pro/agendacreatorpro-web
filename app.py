...
USERS = {
    ...
    'angelicagadelha@gmail.com': {
        'email': 'angelicagadelha@gmail.com',
        'password': generate_password_hash('Aninha#1'),
        'token': '',
        'ativo': True,
    },
    'lucianedossantosmartins005@gmail.com': {
        'email': 'lucianedossantosmartins005@gmail.com',
        'password': generate_password_hash('Rhay041279'),
        'token': '',
        'ativo': True,
    },
}
...
@app.route('/gerar-juridica', methods=['POST'])
@login_required
def gerar_pdf_juridica_route():
    try:
        ...
        nome = f"Agenda_Juridica_{ano}_{tema_nome}_{formato}.pdf"
        return send_file(buffer, mimetype='application/pdf', as_attachment=True, download_name=nome)
    except Exception as e:
        import traceback
        traceback.print_exc()
...
@app.route('/preview-juridica', methods=['POST'])
@login_required
